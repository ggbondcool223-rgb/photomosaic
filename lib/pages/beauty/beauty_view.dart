...
class BeautyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final logic = Get.find<BeautyLogic>();
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      _buildBeautyButton(
                        icon: Icons.blur_on,
                        label: Lang.beautySmooth,
                        color: AppTheme.menuColors[0],
                        onTap: () => logic.showBeautySlider('smooth'),
                      ),
                      SizedBox(width: AppTheme.spacingS),
                      _buildBeautyButton(
                        icon: Icons.wb_sunny,
                        label: Lang.beautyWhiten,
                        color: AppTheme.menuColors[1],
                        onTap: () => logic.showBeautySlider('whiten'),
                      ),
                      SizedBox(width: AppTheme.spacingS),
                      _buildBeautyButton(
                        icon: Icons.face,
                        label: Lang.beautySlimFace,
                        color: AppTheme.menuColors[2],
                        onTap: () => logic.showBeautySlider('slimFace'),
                      ),
                      SizedBox(width: AppTheme.spacingS),
                      _buildBeautyButton(
                        icon: Icons.remove_red_eye,
                        label: Lang.beautyBigEyes,
                        color: AppTheme.menuColors[3],
                        onTap: () => logic.showBeautySlider('bigEyes'),
                      ),
                      SizedBox(width: AppTheme.spacingS),
                      _buildBeautyButton(
                        icon: Icons.visibility,
                        label: Lang.beautyBrightEyes,
                        color: AppTheme.menuColors[4],
                        onTap: () => logic.showBeautySlider('brightEyes'),
                      ),
                      SizedBox(width: AppTheme.spacingS),
                      _buildBeautyButton(
                        icon: Icons.sentiment_satisfied,
                        label: Lang.beautyWhitenTeeth,
                        color: AppTheme.menuColors[5],
                        onTap: () => logic.showBeautySlider('whitenTeeth'),
                      ),
                    ],
                  ),
                ),
